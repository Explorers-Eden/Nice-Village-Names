...
execute as @e[type=marker,tag=village.name] at @s unless entity @e[type=villager,tag=eden.villagename.set,distance=..64] run kill @s
...
execute as @e[type=villager,tag=eden.villagename.set] unless entity @e[type=marker,tag=village.name,distance=..64] run tag @s remove eden.villagename.set

execute as @e[type=player,tag=!at_village] at @s if entity @e[type=marker,tag=village.name,distance=..64] unless score @s village_names matches 1 run function village_names:display_name/entering with entity @n[type=marker,tag=village.name]
...
execute as @e[type=#eden:valid_for_village_healing] at @s if entity @e[type=marker,tag=village.name,distance=..64] unless predicate eden:time/night_time run effect give @s regeneration 5 0 true
